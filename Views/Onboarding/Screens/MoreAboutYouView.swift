...
struct MoreAboutYouView: View {
    ...
    /// Focus states for job & work location input field
        ...
        VStack {
            ...
            HStack {
                ...
                Images.smily
                    ...
                    .padding(.bottom, 20)
                    .onTapGesture {
                        //TODO: Push user details on Cloud
                        /// job: store jop input field data
                        /// workLocation: store work location input field data
                        /// relationStatus: store releation status
                        /// gender: store selected gender
                        /// interestedInto: store interested into data from choices
