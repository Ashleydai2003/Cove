...
struct AlmaMaterView: View {
    ...
    /// Track search text and bind with Textfield
    ...
    /// State varaible to store selected university
        ...
        VStack {
            ...
            HStack {
                ...
                Images.smily
                    ...
                    .padding(.bottom, 20)
                    .onTapGesture {
                        //TODO: Push selected university to cloud
                        /// selectedUniversity: store selected university
